...
if (isset($_POST['Guardar'])) {
    ...
    if  ($Resultado) {
        echo "<script> alert('$Titulo_producto Guardado con éxito'); window.location= '../Views_publicar/Vista_producto.php'</script>";
    } else {
        echo "<script> alert('Hubo un error al publicar el producto. Por favor, inténtelo de nuevo.'); window.location= 'historia_form.php'</script>";
    }
